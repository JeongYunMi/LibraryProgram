...
public class DBConnection{
    ...
    /*
     * 회원 정보 조회 메소드
     * BookInfo의 모든 데이터를 받아와 DefaultTableModel 형태로 정리하여
    ...
    /*
     * 멤버 삭제 메소드
     * String 값으로 받아온 number를 통해 BookInfo의 BookNum 중 number와
     * 같은 값이 데이터를 찾아 삭제한다.
     * */
...
>>>>>>> Final
    ...
    /*
     * 책 반환 데이터를 처리해주는 메소드
     * Booknumber를 통해 빌린 책을 조회하여
     * loanDate, returnDate, loanPerson 값을 0으로 update한다.
     * */
